...
function players(){    //movimento dos players
  ...
  if(ball[1] < 560 && ball[1] > 40){ //limitação de movimento do player 2
  playersArray.splice(1,1,ball[1]-50) //movimento automatico do player 2
  }
...
function movBall(){    //movimento da bolinha
  ...
  if (ball[1] == height || ball[1] == height - height){
    ...
    // console.log(ball.splice(4,1,ball[4]*-1))
    }
}
